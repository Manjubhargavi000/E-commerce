...
export default function ElectronicPage() {
  ...
  const filteredProducts = products
    .filter((product) => {
      ...
      return product.category === 'Electronic' && matchesSearch;
    })
    .sort((a, b) => {
      ...
      <section className="hero-banner">
        ...
        <div className="hero-content">
          <span className="hero-tagline">
            <Sparkles size={14} className="tag-spark" /> Electronic Essentials
          </span>
          <h1 className="hero-title">Discover Essential Electronics</h1>
          <p className="hero-subtitle">
            Browse the latest gadgets, audio gear, and smart devices designed for everyday convenience.
          </p>
        </div>
        <div className="hero-visual">
          <div className="hero-image-card">
            <img
              src="https://images.unsplash.com/photo-1510552776732-208f6e54240c?w=800&auto=format&fit=crop&q=80"
      ...
      <section className="shop-section">
        <div className="shop-header">
          <div className="shop-title-wrapper">
            <h2 className="shop-section-title">Electronic Products</h2>
            <p className="shop-section-subtitle">Showing {filteredProducts.length} products</p>
          </div>
        ...
        {filteredProducts.length > 0 ? (
          ...
          <div className="empty-results">
            ...
            <p>Try another search or see other categories.</p>
          </div>
        )}
      </section>
    </main>
