...
export default function WomenPage() {
  ...
  const womenSubCategories = ['All', 'Sarees', 'Kurti', 'Eastern Wear', 'Indo-Eastern', 'Jeans', 'Shirts', 'T-Shirts'];

  // Filtering & Sorting logic - Only show Women products
  const filteredProducts = products
    .filter((product) => {
      const matchesSearch =
        product.name.toLowerCase().includes(searchQuery.toLowerCase()) ||
        product.description.toLowerCase().includes(searchQuery.toLowerCase());
      const isWomensProduct = product.category === 'Women';
      const matchesSubCategory = selectedSubCategory === 'All' || product.subCategory === selectedSubCategory;
      return matchesSearch && isWomensProduct && matchesSubCategory;
    })
    .sort((a, b) => {
      ...
      <section className="hero-banner">
        ...
        <div className="hero-content">
          <span className="hero-tagline">
            <Sparkles size={14} className="tag-spark" /> Elegant Women's Collection
          </span>
          <h1 className="hero-title">Explore Sophisticated Women's Fashion</h1>
          <p className="hero-subtitle">
            Discover our exclusive collection featuring traditional sarees, modern kurtis, eastern wear, and contemporary fashion pieces for every celebration.
          </p>
        ...
        <div className="hero-visual">
          <div className="hero-image-card">
            <img
              src="https://images.unsplash.com/photo-1610119450866-d0a98e43c657?w=800&auto=format&fit=crop&q=80"
      ...
      <section id="shop-section" className="shop-section">
        <div className="shop-header">
          <div className="shop-title-wrapper">
            <h2 className="shop-section-title">Women's Fashion</h2>
